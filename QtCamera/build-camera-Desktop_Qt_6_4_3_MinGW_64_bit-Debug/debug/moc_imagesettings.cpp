...
#include <memory>
#include "../../camera - Copy/imagesettings.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_ImageSettings_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_ImageSettings_t qt_meta_stringdata_ImageSettings = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_ImageSettings[] = {
...
Q_CONSTINIT const QMetaObject ImageSettings::staticMetaObject = { {
    ...
    qt_meta_stringdata_ImageSettings.offsetsAndSizes,
    qt_meta_data_ImageSettings,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_ImageSettings_t,
        // Q_OBJECT / Q_GADGET
