...
#include <memory>
#include "../../camera - Copy - Copy/videosettings.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_VideoSettings_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_VideoSettings_t qt_meta_stringdata_VideoSettings = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_VideoSettings[] = {
...
Q_CONSTINIT const QMetaObject VideoSettings::staticMetaObject = { {
    ...
    qt_meta_stringdata_VideoSettings.offsetsAndSizes,
    qt_meta_data_VideoSettings,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_VideoSettings_t,
        // Q_OBJECT / Q_GADGET
